...
export default function VideoDemos(props) {
  ...
  return (
    <div>
      ...
      />
      <section className='demos-section fade-in' id={props.id || ""}>
      <div className='video-container'>
          <div className='video-box'>
          <YouTube videoId='o5usLPE9nm4' opts={opts} className={opts.className}/>
          </div>
        ...
        <div className='video-container'>
          <div className='video-box'>
          <YouTube videoId='twyL0udfFfk' opts={opts} className={opts.className} />
          </div>
          <div className='description'>
        ...
        <div className='video-container'>
          <div className='video-box'><YouTube videoId='hvBKiI04jVU' opts={opts} className={opts.className} /></div>
          <div className='description'>
