          ...
          <div className='row'>
            <OwlCarousel className='owl-carousel owl-theme' id='projects-carousel' {...options}>
                    <div className='col-lg-12'  >
                        <a className="top" href='http://paravoscafe.com'
                        ><img src='Projects/Paravos-Cafe-img.png' alt='Paravos Cafe'></img>
                        </a>
                    </div>
                    <div className='col-lg-12'>
                        <a href='https://wed-check-app.herokuapp.com' ><img src='Projects/wed-check.png' alt='Paravos Cafe'></img>
                        </a>
                    </div>
                    <div className='col-lg-12'>
                        <a href='http://sushisaketapp.com'><img src='Projects/sushi-sake-tapp.png' alt='Paravos Cafe'></img>
                        </a>
                    </div>
            </OwlCarousel>
          </div>
